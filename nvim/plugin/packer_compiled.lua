...
_G.packer_plugins = {
  ...
  ["bluloco.nvim"] = {
    config = { "\27LJ\2\n/\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\20plugins/bluloco\frequire\0" },
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/bluloco.nvim",
    url = "https://github.com/uloco/bluloco.nvim"
  },
  ["breeze.vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/breeze.vim",
  ...
  ["lexima.vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/lexima.vim",
  ...
  ["vim-isort"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-isort",
  ...
  ["vim-plugin-ruscmd"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-plugin-ruscmd",
  ...
  ["vim-searchindex"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-searchindex",
...
-- Config for: bluloco.nvim
time([[Config for bluloco.nvim]], true)
try_loadstring("\27LJ\2\n/\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\20plugins/bluloco\frequire\0", "config", "bluloco.nvim")
time([[Config for bluloco.nvim]], false)
